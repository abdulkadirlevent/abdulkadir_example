...
class KitaplarController extends GetxController with GetSingleTickerProviderStateMixin {
  ...
  Future<void> loadTabs() async {
    ...
    tabViews.addAll([
      ...
      const Center(child: Text('Çılgınlar için')),
